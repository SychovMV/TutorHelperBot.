...
8. Задание: расположить элементы в хронологической или логической последовательности.
   Дай 4-6 элементов.
   Укажи правильную последовательность.
...
9. Задание с коротким текстом.
   ...
   После текста укажи правильные фрагменты с ошибками и объяснение.
...
- После каждого задания добавляй строку "Ответ:".
